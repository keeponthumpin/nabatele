...
Operating modes
ModeWindBehaviour1 — Free float<5 knWind sets position, winches passive. Validated pendulum regime.2 — Winch automatic8–20 knSolver predicts pose from wind → distributes tension across 12 winches. The hard mode.3 — Winch manual8–20 knOperator drives target, solver enforces geometry constraints.4 — Home—Sequenced retract to land on pontoon. Process TBD; needs Aerotrope sign-off.
